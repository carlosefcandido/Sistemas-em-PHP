<?php		
	...
	$combotipo = '<select name="tabnomtipo" id="tabnomtipo" onChange="verificarTabelas(this.value);" >';
...
?>
                           <form name="formulario" id="formulario" action="" method="post">
							<input type="hidden" name="acao" id="acao" value="addtable" />
							<input type="hidden" name="passo" id="passo" value="1" />
							
                                <div class="cabecForm">Nova tabela de valores</div>
                                <div class="corpoForm">
                                    <table class="tabelaHorizontal">
                                        <tr>
                                            <th width="20%">Nome</th>
                                            <td width="80%"><input type="text" name="tabnomnome" id="tabnomnome" size="70" value="<?php echo $tabela->getCampo("tabnomnome");?>" maxlength="100" OnKeyUp="caixaAlta(this);" /></td>
                                        </tr>
                                        <tr>
                                            <th width="20%">Tipo</th>
                                ...
                                <div class="barraBotoes">
                                    <input type="button" value=" Cadastrar " id="botao" onclick="adicionarTabela('Confirma cadastrar a nova tabela?');" disabled="disabled" />

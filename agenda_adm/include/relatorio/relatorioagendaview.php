...
*/		
		...
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'MÉDICO:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+12);
		$pdf->MultiCell(0,5,$consulta->getCampo("mednome"),0,'L',true);		

		$pdf->SetFont('arial','B',7);		
		$coluna+= 100;
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'ESPECIALIDADE:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+22);
		$pdf->MultiCell(0,5,$consulta->getCampo("espnome"),0,'L',true);		
		...
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'DATA:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+9);
		$pdf->MultiCell(0,5,$consulta->getCampo("agedata"),0,'L',true);		

		$pdf->SetFont('arial','B',7);		
		$coluna+= 40;
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'HORA:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+9);
		$pdf->MultiCell(0,5,$consulta->getCampo("agehora"),0,'L',true);				
		...
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'PACIENTE:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha+1);		
		$pdf->SetX($coluna+14);
		$pdf->MultiCell(0,3,$consulta->getCampo("pacnome"),0,'J',true);

		$pdf->SetFont('arial','B',7);		
		$coluna+= 100;
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'PLANO:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+11);
		$pdf->MultiCell(0,5,$consulta->getCampo("connome"),0,'L',true);
		...
		$pdf->SetY($linha+1);		
		$pdf->SetX($coluna+15);
		$pdf->MultiCell(0,3,$consulta->getCampo("pactelefone"),0,'J',true);		
/*
		$pdf->SetFont('arial','B',7);		
		$coluna+= 40;
		$pdf->SetY($linha);				
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'CARTEIRA:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+15);
		$pdf->MultiCell(0,5,$consulta->getCampo("agenumerocarteira"),0,'L',true);	
*/		

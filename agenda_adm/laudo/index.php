...
{
	acao = "visualizarlaudo";
	local = document.getElementById("local").value;
	//local = "Hospital de Clinicas Dr. Aloa";
	...
	xmlhttp.open("GET","../act.php?login="+login+"&senha="+senha+"&acao="+acao+"&local="+local,true);
	xmlhttp.send(null);
//alert(login="+login+"&senha="+senha+"&acao="+acao+"&local="+local);
}
...
<div id="ajax" style="display: none;" align="center"></div>                  
            	...
            	<tr>
                	<td align="right" style=" padding-right:55px; padding-top:0px">
                        ...
                        <br />
						<input type="hidden" name="local" id="local" value="Hospital de Clinicas Dr. Aloa" />
                        <table cellpadding="0" cellspacing="0" width="152px" height="100px" border="0" style="border:1px solid #006600; background-color:#FDFFFD;">
                            ...
                            <tr><td align="left" valign="bottom" style="color:#006600; padding-left:15px; padding-top:5px">Usu&aacute;rio:</td></tr>
                            <tr>
                            ...
                            <input type="button" name="botao" id="botao" value=" Gerar Laudo " class="botao" onclick="valida_login()" /></td></tr>
                            <tr>
                                <td height="15px"></td>
                            </tr>
                          </table>

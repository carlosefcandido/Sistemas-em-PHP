...
//		$pdf->Link($culna,$linha,190,13,'../include/materias/consultamateriaview.php?cd_noticia='.$paciente->getCampo("pacid"));
		$pdf->MultiCell(0,5,$paciente->getCampo("pacid"),0,'L',true);		
		
		$coluna+= 16;
		$pdf->SetFont('arial','B',7);
		$pdf->SetY($linha);		
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'DATA NASC.:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+17);
		$datanascimento = "";
		if($paciente->getCampo("pacdatanascimento") != NULL){
			$datanascimento = formatarData($paciente->getCampo("pacdatanascimento"));
		}
		$pdf->MultiCell(0,5,$datanascimento,0,'L',true);		
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+14);
		$pdf->MultiCell(0,5,$paciente->getCampo("pacnome"),0,'L',true);		
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+16);
		$pdf->MultiCell(0,5,$paciente->getCampo("pacendereco"),0,'L',true);		
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+13);
		$pdf->MultiCell(0,5,$paciente->getCampo("pacnumero"),0,'L',true);				
		...
		$pdf->SetY($linha+1);		
		$pdf->SetX($coluna+12);
		$pdf->MultiCell(0,3,$paciente->getCampo("pacbairro"),0,'J',true);
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+11);
		$pdf->MultiCell(0,5,$paciente->getCampo("cidnome"),0,'L',true);
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+12);
		$pdf->MultiCell(0,5,$paciente->getCampo("estuf"),0,'L',true);		
		...
		$pdf->SetY($linha+1);		
		$pdf->SetX($coluna+15);
		$pdf->MultiCell(0,3,$paciente->getCampo("pactelefone"),0,'J',true);

		$coluna+= 80;
		$pdf->SetFont('arial','B',7);
		$pdf->SetY($linha);		
		$pdf->SetX($coluna);
		$pdf->MultiCell(0,5,'CELULAR:',0,'L',true);
		$pdf->SetFont('arial','',7);		
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+14);
		$pdf->MultiCell(0,5,$paciente->getCampo("paccelular"),0,'L',true);

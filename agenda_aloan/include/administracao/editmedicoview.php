...
?>
                           <form name="formulario" id="formulario" action="" method="post">
							<input type="hidden" name="acao" id="acao" value="editmedico" />
							...
							<input type="hidden" name="login" id="login" value="<?php echo $medico->getCampo("usulogin");?>" />														
							<input type="hidden" name="perfil" id="perfil" value="M" />							
							
                                <div class="cabecForm">Alterar m&eacute;dico</div>
                                <div class="corpoForm">
                                    <table class="tabelaHorizontal">
                                        ...
                                        <tr>
											...
											Número <input type="text" name="medregistro" id="medregistro" size="20" value="<?php echo $medico->getCampo("medregistro");?>" maxlength="12" OnKeyUp="caixaAlta(this);" />
                                ...
                                <div class="barraBotoes">
                                    <input type="button" value=" Alterar " id="botao" onclick="adicionarMedico('Confirma alterar o médico?');" />

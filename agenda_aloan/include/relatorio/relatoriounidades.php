...
//		$pdf->Link($culna,$linha,190,13,'../include/materias/consultamateriaview.php?cd_noticia='.$paciente->getCampo("pacid"));
		$pdf->MultiCell(0,5,$unidade->getCampo("uniid"),0,'L',true);		
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+14);
		$pdf->MultiCell(0,5,$unidade->getCampo("uninome"),0,'L',true);		
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+16);
		$pdf->MultiCell(0,5,$unidade->getCampo("uniendereco"),0,'L',true);		
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+13);
		$pdf->MultiCell(0,5,$unidade->getCampo("uninumero"),0,'L',true);				
		...
		$pdf->SetY($linha+1);		
		$pdf->SetX($coluna+12);
		$pdf->MultiCell(0,3,$unidade->getCampo("unibairro"),0,'J',true);
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+11);
		$pdf->MultiCell(0,5,$unidade->getCampo("cidnome"),0,'L',true);
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+12);
		$pdf->MultiCell(0,5,$unidade->getCampo("estuf"),0,'L',true);		
		...
		$pdf->SetY($linha+1);		
		$pdf->SetX($coluna+15);
		$pdf->MultiCell(0,3,$unidade->getCampo("unitelefone1"),0,'J',true);
		...
		$pdf->SetY($linha);		
		$pdf->SetX($coluna+14);
		$pdf->MultiCell(0,5,$unidade->getCampo("unitelefone2"),0,'L',true);

...
### $this->jpg_quality is an optional value (0-100) that'll set the quality of the JPEG produced
  function dcm_to_jpg() {
	...
	$caminho = "c:/wamp/www/agenda/dicom/examples";
    $convert_cmd = $caminho . "/dcmj2pnm +oj +Jq " . $this->jpg_quality . " --use-window 1 \"" . $this->file . "\" \"" . $this->jpg_file . "\"";
	echo "<br>".$convert_cmd."<br><br>";
    ...
    if($filesize < 10) {
      $convert_cmd = $caminho . "/dcmj2pnm +Wm +oj +Jq " . $this->jpg_quality . " \"" . $this->file . "\" \"" . $this->jpg_file . "\"";
	  	echo "<br>".$convert_cmd."<br><br>";
      $out = Execute($convert_cmd);
	  	echo $out."<br><br>";
    }

	echo "<br>".$this->jpg_file."<br>";

<?php
	...
	$combotipo = '<select name="tabnomtipo" id="tabnomtipo" onChange="buscarTabelas(\'uploadtableview\',this.value);" >';
...
?>
						   ...
						   <input type="hidden" name="acao" value="uploadtable" />
						   <input type="hidden" name="passo" value="1" />
                                <div class="cabecForm">Upload de valores</div>
                                <div class="corpoForm">
                                ...
                                <div class="barraBotoes">
                                    <input type="button" value=" Upload " id="botao" onclick="uploadValoresTabela('Confirma o upload dos valores?');" disabled="disabled" />

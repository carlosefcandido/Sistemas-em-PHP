...
else if (document.getElementById("senha") == null)
{
  ...
  valida_login(document.getElementById("acao"));
}
return false;
}
-->
...
function valida_login(acao)
{
	...
	xmlhttp.open("GET","act.php?login="+login+"&senha="+senha+"&acao="+acao.value,true);
	xmlhttp.send(null);
}
...
<div id="ajax" style="display: none;" align="center"></div>                  
            	...
            	<tr>
                	<td align="right" style=" padding-right:55px; padding-top:0px">
                        ...
                        <table cellpadding="0" cellspacing="0" width="152px" height="100px" border="0" style="border:1px solid #006600; background-color:#FDFFFD;">
                            ...
                            <input type="button" name="acao" id="acao" value="Logar" class="botao" onclick="valida_login(this)" /></td></tr>
                            <tr>
                                <td height="15px"></td>
                            </tr>
                          </table>
                ...
                <tr align="center">
                    <td>
                        <img src="imagens/logo_medifile2.JPG" width="100" height="25">
                    </td>
                </tr>
                        
                    <span style="position:relative; top:360px; text-align:center; font-size: 10px"><a href="http://www.mprado.info" target="_blank">MPrado Serviços de Inform&aacute;tica Ltda</a></span>
            </table>
        </td>   
    </tr>
</table>            

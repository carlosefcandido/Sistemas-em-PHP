<?php
	...
	$comboestadocivil = montaComboEstadoCivil($paciente->getCampo("pacestadocivil"),'pacestadocivil');
	$combonacionalidade = montaComboNacionalidade($paciente->getCampo("pacnacionalidade"),'pacnacionalidade');	
...
?>
                           <form name="formulario" id="formulario" action="" method="post">
							<input type="hidden" name="acao" id="acao" value="editpaciente" />
							<input type="hidden" name="pacid" id="pacid" value="<?php echo $paciente->getCampo("pacid");?>" />
							
                                <div class="cabecForm">Alterar paciente</div>
                                <div class="corpoForm">
                                    <table class="tabelaHorizontal">
                                        ...
                                        <tr>
                                            ...
                                            <td width="80%"><input type="text" name="pacdatanascimento" id="pacdatanascimento" size="10" value="<?php echo formatarData($paciente->getCampo("pacdatanascimento"));?>" maxlength="10" onclick="displayCalendar(document.formulario.pacdatanascimento,'dd/mm/yyyy',this)" /></td>
                                        </tr>
                                        <tr>
                                            <th width="20%">Sexo</th>
                                ...
                                <div class="barraBotoes">
                                    <input type="button" value=" Alterar " id="botao" onclick="adicionarPaciente('confirma alterar o paciente?');" />
